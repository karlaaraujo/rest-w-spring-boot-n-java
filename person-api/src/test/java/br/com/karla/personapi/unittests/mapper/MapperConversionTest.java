package br.com.karla.personapi.unittests.mapper;
...
import br.com.karla.personapi.unittests.mapper.mocks.PersonMock;
...
public class MapperConversionTest {
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = Mapper.parseObjects(inputObject.mockEntityList(), PersonVO.class);
    ...
    public void parserVOListToEntityListTest() {
        List<Person> outputList = Mapper.parseObjects(inputObject.mockVOList(), Person.class);
